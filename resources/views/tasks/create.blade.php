            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-2">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4 ml-0 m-auto w-full">
                    <form class="grid grid-cols-4 gap-3 w-full sm:w-full" method="POST">
                        ...
                        <div class="block"><input name="start_date" id="start_date" value="" type="date" />
                        </div>
                        <div class="text-right font-bold p-3 block">
                            <label for="start_time">Time:</label>
                        </div>
                        <div class="block"><input name="start_time" id="start_time" value="" type="time" />
                        </div>
                        ...
                        <div class="col-span-3">
                            <input name="destination" id="destination" value="" type="text"class="w-full" />
                        </div>
                        <div class="p-1 text-gray-900">
